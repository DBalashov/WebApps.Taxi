...
export class ServiceConnector {
    ...
    public GetOnlineInfo(ids?: string[] | null): Promise<IGetOnlineInfoItem[]> {
    ...
    public GetCommandLog(sd: Date, ed: Date) {
        return this.post<ICommandResultItem[]>('GetCommandLog',
            {
                session: this.token,
                schemaID: this.schemaID,
                SD: moment(sd).format(this.FMT_DT),
...
export enum DeviceCommandType {
    ...
    GAPNFULL,    APNFULL,
    GPIN,        PIN,
    GPERIODSEND,        PERIODSEND,
    GAPNROAMING,        APNROAMING,
    GROAMINGMODE,       ROAMINGMODE,
    GPERIODROAMING,     PERIODROAMING,
    ////////////////////////
    GSIM2TELNUM,        SIM2TELNUM,
    GSIM2PIN,           SIM2PIN,
    GSIM2PERIODSEND,    SIM2PERIODSEND,
    GSIM2APNFULL,       SIM2APNFULL,
    GSIM2APNROAMING,    SIM2APNROAMING,
    GSIM2ROAMINGMODE,   SIM2ROAMINGMODE,
    GSIM2PERIODROAMING, SIM2PERIODROAMING,
    ////////////////////////
    MESSAGE,
    GPERIODWR, PERIODWR,
    GMODEWR,   MODEWR,
    GADAPTIVESENS, ADAPTIVESENS,
    GMODE1,        MODE1,
    GMODEWIDE,     MODEWIDE,
    GMODETN,       MODETN,
    GFULLONLINE,   FULLONLINE,
    GDISTANCE,     DISTANCE,
    GP285,         P285,
    GCOMPACT,      COMPACT
}
